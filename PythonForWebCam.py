...
config = {
  ...
  "appId": "1:370397575421:web:78fdf136b7c25ec2b72694"
}
...
# Log the user in
user = auth.sign_in_with_email_and_password("tereterepashi@gmail.com", "Terepashi.1")
...
def run(model: str, camera_id: int, width: int, height: int, num_threads: int,
  ...
  detection_options = processor.DetectionOptions(
      max_results=3, score_threshold=0.6)
  ...
  while cap.isOpened():
    ...
    imagestring = urllib.parse.quote(image_string)
    database.child("image").set(imagestring) 
